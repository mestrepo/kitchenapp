...
Router.privateRoutes = [
	...
	"admin.users.edit",
	"admin.kitchenstaff",
	"admin.kitchenstaff.insert",
	"admin.kitchenstaff.update",
	"admin.kitchenstaff.details",
	"user_settings",
...
Router.roleMap = [
	...
	{ route: "admin.kitchenstaff",	roles: ["admin"] },
	{ route: "admin.kitchenstaff.insert",	roles: ["admin"] },
	{ route: "admin.kitchenstaff.update",	roles: ["admin"] },
	{ route: "admin.kitchenstaff.details",	roles: ["admin"] },
...
Router.map(function () {
	...
	this.route("/admin/kitchenstaff", {name: "admin.kitchenstaff", title: "", controller: "AdminKitchenstaffController"});
	this.route("/admin/kitchenstaff/insert", {name: "admin.kitchenstaff.insert", title: "", controller: "AdminKitchenstaffInsertController"});
	this.route("/admin/kitchenstaff/update/:kitchenstaffId", {name: "admin.kitchenstaff.update", title: "", controller: "AdminKitchenstaffUpdateController"});
	this.route("/admin/kitchenstaff/details/:kitchenstaffId", {name: "admin.kitchenstaff.details", title: "", controller: "AdminKitchenstaffDetailsController"});
